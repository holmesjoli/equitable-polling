...
export const selectVariable = {
    ...
    equityIndicator: [{id: '0', variable: '', descr: 'None'},
                    //   {id: '1', variable: '', descr: 'Total # registered voters'},
                    //   {id: '2', variable: '', descr: '# polls per # registered voters'},
                      {id: '3', variable: 'percentage_race_black_african_american', descr: '% Black'},
                    //   {id: '4', variable: '', descr: 'Age demographics'},
                      {id: '5', variable: 'population_density', descr: 'Population density'},
                    //   {id: '6', variable: '', descr: 'Nearest time to poll'}
                ],
