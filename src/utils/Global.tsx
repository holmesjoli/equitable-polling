...
export const layersStyle = {default: { color: '#757575', fillColor: "#FAF6F0", pointer: 'cursor', fillOpacity: 0.5, weight: 1 },
                            selected: {color: '#757575', fillColor: "#FAF6F0", pointer: 'default', fillOpacity: 0, weight: 2 },
